...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.supervision": "Agent Supervision Controls",
  "tools.supervision.enabled": "Enable Agent Supervision Controls",
  "tools.supervision.allowAgents": "Agent Supervision Allowlist",
